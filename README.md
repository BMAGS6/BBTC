...
## NOTE (August 7th, 2026): I have begun work on a rewrite of BBTC, this time adding a new library and an internal ballistic solver. Thus, the entire repo before this point **IS DEPRECATED**!
##  Overview
